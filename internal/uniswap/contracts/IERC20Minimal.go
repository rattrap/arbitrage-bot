...
func (_IERC20Minimal *IERC20MinimalCaller) Decimals(opts *bind.CallOpts) (uint8, error) {
	var out []interface{}
	err := _IERC20Minimal.contract.Call(opts, &out, "decimals")
...
//
// Solidity: function decimals() view returns(uint8)
func (_IERC20Minimal *IERC20MinimalSession) Decimals() (uint8, error) {
	return _IERC20Minimal.Contract.Decimals(&_IERC20Minimal.CallOpts)
}

// Decimals is a free data retrieval call binding the contract method 0x313ce567.
//
// Solidity: function decimals() view returns(uint8)
func (_IERC20Minimal *IERC20MinimalCallerSession) Decimals() (uint8, error) {
	return _IERC20Minimal.Contract.Decimals(&_IERC20Minimal.CallOpts)
}
